...
<html class="no-js" lang="zxx">
    <%
        ...
        List<User> topUser = userDao.getTopInstructors();
    %>
                                            ...
                                            <div class="box-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column fw-500">
                                                            <a href=""
                                                               class="text-dark hover-primary mb-1 fs-16">${i.getUserName()}</a>
                                                            <span class="text-fade">${i.getTotalLearners()} Enrolled</span>
                                                        </div>
                                                    </div>

                                                    <div class="d-flex align-items-center">
                                                        <a href="course.html"
                                                           class="waves-effect waves-light btn btn-sm btn-secondary">Profile</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
