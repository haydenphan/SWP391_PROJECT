                            ...
                            <div class="course-video-widget">
                                <div class="course-widget-wrapper mb-30">
                                    ...
                                    <div class="button-container" style="text-align: center;">
                                        <form action="${pageContext.request.contextPath}/Cart/add-to-cart" method="POST" style="display: inline-block; margin-right: 10px;">
                                            <div class="video-wishlist">
                                                <input type="hidden" name="CourseID" value="<%=rCourse.getCourseID()%>">
                                                <button type="submit" class="video-cart-btn"><i class="fal fa-shopping-cart"></i> Add to cart</button>
                                            </div>
                                        </form>
                                        <form action="${pageContext.request.contextPath}/Wishlist/add-to-wishlist" method="POST" style="display: inline-block;">
                                            <div class="video-wishlist">
                                                <input type="hidden" name="CourseID" value="<%=rCourse.getCourseID()%>">
                                                <button type="submit" class="video-wishlist-btn"><i class="far fa-heart"></i> Add to Wishlist</button>
                                            </div>
                                        </form>
                                    </div>
