    ...
    <head>
        ...
        <script>
            function deleteOrder(CourseID) {
                ...
                var url = contextPath + "/Cart/remove-from-wishlist?CourseID=" + CourseID;
                $.ajax({
                    url: url,
                    type: "get",
                        ...
                        <div class="col-12">
                            <div class="table-content table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <% 
                                        HashMap<Integer, ProductCart> wishlist = (HashMap<Integer, ProductCart>) request.getAttribute("wishlist"); // Change "cart" to "wishlist"
                                        double total = 0;
                                        if (wishlist != null && !wishlist.isEmpty()) {
                                            for (ProductCart item : wishlist.values()) {
                                                Course course = item.getCourse();
                                                double itemTotal = course.getPrice() * item.getQuantity();
                                                total += itemTotal;
                                        %>
                                        <tr>
