                                    ...
                                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        ...
                                        <ul class='student-profile-info'>
                                            <li>
                                                ...
                                                <span>${account.registrationDate}</span>
                                            </li>
                                            <li>
                                                <h5>First Name :</h5>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="profileA" role="tabpanel"
                                                    ...
                                                    <div class="student-profile-settings">
                                                        ...
                                                        <form action="/user-profile/update">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="contact-from-input mb-20">
                                                                        ...
                                                                        <textarea id='Bio' name ='bio'
                                                                                  placeholder="${account.bio}"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="contact-from-input mb-20">
                                                                    ...
                                                                    <input id='Current' name="oldPassword" type="password"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="contact-from-input mb-20">
                                                                    ...
                                                                    <input id='Retype' name = "newPasswordRetype" type="password"
                                                                           placeholder="Type password" />
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12">
