                        ...
                        <div class="col-xl-7 col-lg-7 col-md-5 col-sm-9 col-9">
                            <div class="header-left d-flex align-items-center">
                                <div class="header-logo">
                                    <c:choose>
                                        <c:when test="${role == 1}">
                                            <c:set var="rolePath" value="1" />
                                        </c:when>
                                        <c:when test="${role == 2}">
                                            <c:set var="rolePath" value="2" />
                                        </c:when>
                                        <c:when test="${role == 3}">
                                            <c:set var="rolePath" value="3" />
                                        </c:when>
                                        <c:otherwise>
                                            <c:set var="rolePath" value="0" />
                                        </c:otherwise>
                                    </c:choose>
                                        ...
                                        <div class="header-search d-none d-xxl-block mr-30">
                                            <form action="${pageContext.request.contextPath}/search" method="get">
                                                <div class="search-icon p-relative">
                                                    <input style="width: 300px" name="txt" type="text" placeholder="Search courses...">
