...
<html class="no-js" lang="zxx">
    ...
    <body>
        ...
        <main>
            ...
            <!-- features-area-start -->
            <div class="features-area section-bg fix long-padding pt-110">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title text-center mb-60">
                                <h2>Global Online <br>
                                    Education <span class="down-mark-line-2">Categories</span></h2>
                            </div>
                        </div>
                            ...
                            <div class="">
                                <div class="features-video-wrapper">
                                    <div class="features-shape-wrapper-1">
                                        <img class="features-shape" src="${pageContext.request.contextPath}/img/shape/features-shape.png" alt="features-shape">
                                        Get <span>help</span> from <br> this video

                                    </div>
                                    <div class="features-shape-werapper-2">
                                        <span>65k+</span> <br>views daily
                                        <img class="features-shape-2" src="${pageContext.request.contextPath}/img/shape/features-shape-2.png"
                                             alt="features-shape-2">
                                    </div>
                                    <div class="reatures-video-thumb">
                                        <img src="${pageContext.request.contextPath}/img/features/features.jpg" alt="features-img">
                                    </div>
                    ...
                    <div class="know-us-border pt-110">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="know-us-wrapper mb-30">
                                    <div class="know-us-better-thumb">
                                        <a href="#"><img src="${pageContext.request.contextPath}/img/gallery/gallary-06.jpg" alt="know-us-img"></a>
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="know-us-wrapper mb-30">
                                    <div class="know-us-better-thumb">
                                        <a href="#"><img src="${pageContext.request.contextPath}/img/gallery/gallary-07.jpg" alt="know-us-img"></a>
                                    </div>
                                    <div class="know-us-text text-center">
                                        <a href="#">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="know-us-wrapper mb-30">
                                    <div class="know-us-better-thumb">
                                        <a href="#"><img src="${pageContext.request.contextPath}/img/gallery/gallary-08.jpg" alt="know-us-img"></a>
                                    </div>
                                    <div class="know-us-text text-center">
                                        <a href="#">
                    ...
                    <div class="row justify-content-center text-center">
                        <div class="col-xl-6 col-md-8">
                            <div class="become-intructor-text">
                                ...
                                <a class="edu-btn" href="${pageContext.request.contextPath}/pages/become-instructor.jsp">Get started now</a>
                            </div>
                        </div>
                    </div>
                </div>
