...
public class LectureMaterialDAO extends DAO<LectureMaterial> {
    ...
    public static int countMaterialsByCourseID(int courseID) {
        int count = 0;
        String sql = "SELECT COUNT(*) FROM LectureExtraMaterials lem "
                + "JOIN Lectures l ON lem.LectureID = l.LectureID "
