                ...
                <div class="browser-course-wrapper course-height" data-background="">
                    ...
                    <div class="browser-course-content">
                        ...
                        <div class="browser-btn">
                            <a class="course-btn" href="${pageContext.request.contextPath}/pages/become-instructor.jsp">View details</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-7">
                            <div class="browser-course-content">
                                ...
                                <div class="browser-btn">
                                    <a class="course-btn" href="${pageContext.request.contextPath}/CourseList">Browse courses</a>
                                </div>
                            </div>
                        </div>
                    </div>
