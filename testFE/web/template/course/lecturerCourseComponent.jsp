...
<div class="col-xl-6 col-lg-6 col-md-6 col-md-6">
    <div class="eduman-course-main-wrapper mb-30">
        <div class="eduman-course-img w-img">
            <a href="course-details.html"><img src="${pageContext.request.contextPath}/<%=currentCourse.getImageURL()%>"
                                               alt="course-img"></a>
        </div>
        <div class="eduman-course-wraper">
            ...
            <div class="eduman-course-meta">
                ...
                <div class="eduman-course-tutor">
                    <a href="instructor-profile.html"><img width="35" style="border-radius: 30px"
                            src="<%=((User)session.getAttribute("user")).getAvatar()%>" alt="tutor-img"></a>
        ...
        <div class="eduman-course-footer">
            ...
            <div class="course-deteals-btn">
                <a href="../view-section-servlet?courseId=<%=currentCourse.getCourseID()%>"><span class="me-2">View Details</span><i
