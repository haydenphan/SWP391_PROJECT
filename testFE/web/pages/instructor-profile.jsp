                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="quiz-tab" data-bs-toggle="tab" data-bs-target="#quiz"
                                                ...
                                                class="fas fa-cubes"></i> Question Bank</button>
                                    </li>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="ques-tab" data-bs-toggle="tab" data-bs-target="#ques"
                                                ...
                                                class="fas fa-fist-raised"></i> Create Quizz</button>
                                    </li>
                            ...
                            <div class="student-profile-content">
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="quiz" role="tabpanel" aria-labelledby="quiz-tab">
                                        <form style="margin-bottom: 50px" action="${pageContext.request.contextPath}/question-bank" method="POST">
                                            <button type='submit' class="cont-btn">Question Bank</button>
                                        </form>
