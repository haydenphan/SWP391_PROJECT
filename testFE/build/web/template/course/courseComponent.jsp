...
<div class="col-xl-4 col-lg-6 col-md-6">
    <div class="course-wrapper-2 mb-30">
        <div class="student-course-img">
            <img src="${currentCourse.imageURL}" alt="course-img">
        </div>
        <div class="course-cart">
            <div class="course-info-wrapper">
                <div class="cart-info-body">
                    <span class="category-color category-color-1"><a href="${pageContext.request.contextPath}/CourseList?subcategoryID=${currentCourse.subcategoryID}">${currentCourse.subcategoryName}</a></span>
                    <a href="${pageContext.request.contextPath}/pages/courseDetails.jsp?courseID=${currentCourse.courseID}">
                        <h3>${currentCourse.courseName}</h3>
                    </a>
                    <div class="cart-level">
                        <h5>Level : <span>${currentCourse.levelName}</span></h5>
