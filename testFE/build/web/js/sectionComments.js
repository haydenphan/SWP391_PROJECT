...
function submitComment() {
    ...
    if (commentText.trim() !== '') {
        ...
        fetch('SectionComments?sectionID=' + sectionID + '&content=' + commentText, {
            method: 'POST'
        })
...
function submitReply(commentId, repliedToUserID, nearCommentId) {
    ...
    if (replyText.trim() !== '') {
        // Post the new reply to the backend
        fetch('SectionComments?sectionID=' + sectionID + '&content=' + replyText
...
function submitEdit(commentID) {
    ...
    // Example of using fetch to send a POST request to your backend endpoint
    fetch('SectionComments?commentID=' + commentID + '&content=' + editedText + '&mode=updating', {
        method: 'PUT',
    })
            .then(response => {
                if (!response.ok) {
