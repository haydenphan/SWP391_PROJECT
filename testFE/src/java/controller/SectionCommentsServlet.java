...
public class SectionCommentsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            int sectionID = Integer.parseInt(request.getParameter("sectionID"));
            Integer parentID = request.getParameter("parentID") != null
                    ? Integer.parseInt(request.getParameter("parentID")) : null;
            Integer repliedToUserID = request.getParameter("repliedToUserID") != null
                    ? Integer.parseInt(request.getParameter("repliedToUserID")) : null;
            ...
            Gson gson = new GsonBuilder()
                    .registerTypeAdapter(LocalDateTime.class, new LocalDateTimeAdapter())
                    .create();
            String commentJson = gson.toJson(insertedComment);
            // Set content type and write JSON response
            response.setContentType("application/json");
            PrintWriter out = response.getWriter();
