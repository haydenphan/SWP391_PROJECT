 ...
 * @author tuan6
 */
@WebServlet(name = "FilterCagoriesServlet", urlPatterns = {"/filter-categories"})
public class FilterCagoriesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int categories = Integer.parseInt(categories_raw);
        List<Course> courses = courseDAO.getSubCategories(categories);
